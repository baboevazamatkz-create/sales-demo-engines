...
|------------------|-----------------|---------|
| `cherish`        | cafe-restaurant | Cherish Bar & Kitchen (Самал-2) — premium-пресет в тёмной винно-медной палитре: всё меню, сет к пиву, бронь трёх банкетных залов |
...
конфиге задаются пресет оболочки (`style.preset` — `premium` / `classic`), светлая
или тёмная палитра (`theme.mood`), фоновая геометрия
